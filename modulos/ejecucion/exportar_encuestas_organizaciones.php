...
header("Content-Disposition: attachment; filename=Reporte Encuestas Organizadiones.xls");
...
foreach ($ejecuciones_tb as $enc) {
    ...
    if ($ejeData->getEncuestaEstado($enc_id) == 1 && $ejeData->getRespuestaPreguntaDeEncuesta(152,$enc_id)!='') {
        echo "<tr>";
