...
while ($contador < $cont) {
    echo "<tr>";
    echo "<td>" . $html->traducirTildes( $compromisos[$contador]['dos_nombre'] ). "</td>
        <td>" . $html->traducirTildes( $compromisos[$contador]['doa_nombre'] ). "</td>
        <td>" . $html->traducirTildes( $compromisos[$contador]['com_actividad'] ). "</td>
        <td>" . $html->traducirTildes( $compromisos[$contador]['com_fecha_entrega'] ). "</td>		
        <td>" . $html->traducirTildes( $compromisos[$contador]['ces_nombre'] ). "</td>
        <td>" . $html->traducirTildes( $compromisos[$contador]['com_observaciones'] ) . "</td>";
    echo "</tr>";
    $contador++;
}
echo "</table>";
