...
while ($contador < $cont) {
    echo "<tr>";
    echo "<td>" . $html->traducirTildes( $correspondencia[$contador]['area'] ). "</td>
        <td>" . $html->traducirTildes( $correspondencia[$contador]['subtema'] ). "</td>	
        <td>" . $html->traducirTildes( $correspondencia[$contador]['autor'] ). "</td>		
        <td>" . $html->traducirTildes( $correspondencia[$contador]['destinatario'] ). "</td>
        <td>" . $html->traducirTildes( $correspondencia[$contador]['responsableR'] ). "</td>
        <td>" . $html->traducirTildes( $correspondencia[$contador]['descripcion'] ). "</td>
        <td>" . $html->traducirTildes( $correspondencia[$contador]['soporte'] ). "</td>
        <td>" . $html->traducirTildes( $correspondencia[$contador]['anexo'] ). "</td>
        <td>" . $html->traducirTildes( $correspondencia[$contador]['fecha'] ). "</td>
        <td>" . $html->traducirTildes( $correspondencia[$contador]['fechamax'] ). "</td>
        <td>" . $html->traducirTildes( $correspondencia[$contador]['codigor'] ). "</td>
        <td>" . $html->traducirTildes( $correspondencia[$contador]['referencia']) . "</td>";
    //   <td>" . $html->traducirTildes( $correspondencia[$contador]['estado'] ). "</td>
    echo "</tr>";
    $contador++;
}
echo "</table>";
