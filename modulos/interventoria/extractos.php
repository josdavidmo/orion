...
switch ($task) {
    case 'list':
        ...
        $form->setTitle(TITULO_LISTAR_EXTRACTO_INT);
        ...
        $form->addInputButton('button', 'btn_exportar', 'btn_exportar', BTN_EXPORTAR, 'button', 'onClick=exportar_archivo_excel_extracto_int();');
        $form->writeForm();
        $criterio = " 1";
        ...
        $form2->addInputButton('button', 'btn_exportar_mov', 'btn_exportar_mov', BTN_EXPORTAR, 'button', 'onClick=exportar_archivo_excel_movimiento_int();');
        $form2->writeForm();
    ...
    case 'add':
        ...
        $form = new CHtmlForm();
        $form->setClassEtiquetas('td_label');
        $form->setTitle(TITULO_AGREGAR_EXTRACTO_INT);
    ...
    case 'saveAdd':
        ...
        $extracto = new CExtractoFinancieroInterventoria('',$data);
    ...
    case 'edit':
        ...
        $extracto = new CExtractoFinancieroInterventoria($id_edit,$data);
    ...
    case 'movimiento':
        ...
        $contador = 0;
        $extracto = new CExtractoFinancieroInterventoria($id,$data);
        $extracto->loadExtracto();
    ...
    case 'saveEditdMovimiento':
        ...
        $extracto = new CExtractoFinancieroInterventoria($id_extracto,$data);
        $extracto->loadExtracto();
    ...
    case 'deleteMovimiento':
        ...
        echo $html->generaAdvertencia(BORRAR_MOVIMIENTO, '?mod=' . $modulo . '&niv=' . $niv . '&task=confirmDeleteMovimiento&id_ext='.$id_extracto.'&id_element=' . $id_delete, 
                '"onClick=location.href="?mod=' . $modulo . '&niv=' . $niv . "&task=movimiento&id_element=$id_extracto");
