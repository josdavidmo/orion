 ...
 */
        ...
        header("Content-Disposition: attachment; filename=RendimientosInterventoria.xls");
        header("Expires: 0");
        ...
        require('../../clases/datos/CRendimientoFinancieroInterventoriaData.php');
...
while ($contador < $cont) {
    ...
    echo "<tr>";
    echo "<td>" . $html->traducirTildes( $html->traducirTildes($elementos[$contador]['cuenta_numero']) ). "</td>	
        <td>" . $html->traducirTildes( $elementos[$contador]['fecha'] ). "</td> 	
        <td>" . $html->traducirTildes( $elementos[$contador]['rendimiento_financiero'] ). "</td> 	
        <td>" . $html->traducirTildes( $elementos[$contador]['descuentos'] ). "</td> 	
        <td>" . $html->traducirTildes( $elementos[$contador]['rendimiento_consignado'] ). "</td>
        <td>" . $html->traducirTildes( $elementos[$contador]['fecha_consignacion'] ). "</td>
        <td>" . $html->traducirTildes( $elementos[$contador]['comprobante_consignacion'] ). "</td>
        <td>" . $html->traducirTildes( $elementos[$contador]['comprobante_emision'] ). "</td>
