...
/**
 * Modulo Piezas Comunicacion
 * Maneja el modulo comunicacion en union con CDocumentoBasico, 
...
$table = 'piezascomunicacion';
$ruta = 'soportePiezasComunicacion';
...
switch ($task) {
    ...
    case 'list':
        $form = new CHtmlForm();
        $form->setTitle(TITULO_PIEZAS_COMUNICACION);
        ...
        $dt->setTitleTable(TITULO_PIEZAS_COMUNICACION);
        $titulos = array(PIEZAS_COMUNICACION_DESCRIPCION, PIEZAS_COMUNICACION_ARCHIVO);
    ...
    case 'saveAdd':
        ...
        $m = ERROR_AGREGAR_PIEZAS_COMUNICACION;
        if ($r == "true") {
            $m = EXITO_AGREGAR_PIEZAS_COMUNICACION;
        }
    ...
    case 'delete':
        ...
        echo $html->generaAdvertencia(CONFIRMAR_BORRAR_PIEZAS_COMUNICACION, '?mod=' . $modulo . '&id_delete=' . $id_delete . '&niv=1&task=confirmDelete', 'onclick=location.href=\'?mod=' . $modulo . '&niv=1\'');
        break;
    ...
    case 'confirmDelete':
        ...
        $m = ERROR_BORRAR_PIEZAS_COMUNICACION;
        if ($r == 'true') {
            $m = EXITO_BORRAR_PIEZAS_COMUNICACION;
        }
    ...
    case 'edit':
        ...
        $form = new CHtmlForm();
        $form->setTitle(TITULO_EDITAR_PIEZAS_COMUNICACION);
        $form->setId('frm_add_capacitacion');
    ...
    case 'saveEdit':
        ...
        $m = ERROR_EDITAR_PIEZAS_COMUNICACION;
        if ($r == "true") {
            $m = EXITO_EDITAR_PIEZAS_COMUNICACION;
        }
        echo $html->generaAviso($m, "?mod=" . $modulo . "&niv=1");
