...
switch ($task){
    ...
    case 'list':
        ...
        $elementos = $docData->getPolizas($criterio, "poliza");
    ...
    case 'add':
        ...
        $form->addTextArea('textarea', 'txt_porcentaje', 'txt_porcentaje', 15, 19, '', '', 'pattern="' . 
                PATTERN_ALFANUMERICO . '" title="' . $html->traducirTildes(TITLE_ALFANUMERICO) . '"');
    ...
    case 'saveAdd':
        ...
        $mesg=$poliza->saveNewPoliza("poliza");
    ...
    case 'edit':
        ...
        $porcentaje=        $poliza->getPorcentajePoliza();
        ...
        $form->addEtiqueta(CAMPO_PORCENTAJE);
        $form->addTextArea('textarea', 'txt_porcentaje', 'txt_porcentaje', 15, 19, $porcentaje, '', 'pattern="' . 
                PATTERN_ALFANUMERICO . '" title="' . $html->traducirTildes(TITLE_ALFANUMERICO) . '"');
    ...
    case 'saveEdit':
        ...
        $poliza->setObservacionesPoliza($observaciones);
        $poliza->setArchivoPoliza($archivo);
        $mesg=$poliza->updatePoliza("poliza");
        echo $html->generaAviso($mesg, "?mod=" . $modulo . "&niv=" . $niv . "&task=list");
        break;
    ...
    case 'confirmDelete':
        ...
        $poliza = new CPoliza($id, $docData);
        $poliza->loadPoliza("poliza");
        $mens = $poliza->deletePoliza("poliza");
