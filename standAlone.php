...
function completarEncuesta($idEncuesta) {
    $query = "UPDATE generador_encuesta SET ees_id = 1 WHERE enc_id = '$idEncuesta'";
    $result = mysql_query($query);
    writeLog($query);
    return $result;
}

function insertarActividad($idActividad, $idBitacora, $fecha, $fechaFin, 
                           ...
                           $cumplimientoEPP, $cumplimientoCertificaciones, $estado) {
...
function insertarGastos($idGastosActividad, $descripcion, $valor, $archivo, 
                        $idTipoGasto, $idActividad) {
...
function insertarRegistroFotografico($idRegistroFotografico, $descripcionRegistroFotografico, 
                                     $archivo, $idActividad) {
...
function insertarHallazgo($idHallazgosPendientes, $observacion, $archivo, $idTipo, 
                          $idActividad) {
    $auxObject = "'$idHallazgosPendientes','$observacion','$archivo','$idTipo',"
            . "'$idActividad',NULL,NULL,NULL,0";
...
$server->register("insertarActividad", array("idActividad" => "xsd:string", 
                                   ...
                                   "estado" => "xsd:string"), 
                                   array("return" => "xsd:boolean"), "urn:standAlone", "urn:standAlone#insertarActividad", "rpc", "encoded", "Agregar nuevas actividades enviadas por los clientes");
...
$server->register("insertarHallazgo", array("idHallazgosPendientes" => "xsd:string", 
                                   ...
                                   array("return" => "xsd:boolean"), "urn:standAlone", "urn:standAlone#insertarHallazgo", "rpc", "encoded", "Agregar nuevos hallazgos enviados por los clientes");
...
$server->register("insertarRegistroFotografico", array("idRegistroFotografico" => "xsd:string", 
                                   ...
                                   "archivo" => "xsd:string", 
                                   "idActividad" => "xsd:string"), 
                                   array("return" => "xsd:boolean"), "urn:standAlone", "urn:standAlone#insertarRegistroFotografico", "rpc", "encoded", "Agregar nuevos registros fotograficos enviados por los clientes");
...
$server->register("insertarGastos", array("idGastosActividad" => "xsd:string", 
                                   ...
                                   "idActividad" => "xsd:string"), 
                                   array("return" => "xsd:boolean"), "urn:standAlone", "urn:standAlone#insertarGastos", "rpc", "encoded", "Agregar nuevos gastos enviados por los clientes");
