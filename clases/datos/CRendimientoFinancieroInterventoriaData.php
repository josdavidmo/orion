...
* @subpackage datos
*/
Class CRendimientoFinancieroInterventoriaData{
    var $db = null;
	...
	function insertRendimiento($rendimiento){
		$tabla = "rendimiento_financiero_int";
        ...
        function getSaldoConsignadoByFecha($cuenta,$mes,$anio){
            $sql = "select sum(rfi_rendimiento_consignado) as saldo
                    from rendimiento_financiero_int
	...
	function getRendimientoInterventoriaById($id){
		...
		$sql = "select r.rfi_id, r.cfi_id, c.cfi_nombre,
                                ...
                                r.rfi_observaciones 
                        from rendimiento_financiero_int r 
...
//		echo ("<br>sql:".$sql);
        ...
        function getIntereses($id,$anio,$mes){
            $sql="SELECT SUM(d.mov_valor) as valor "
                    . "FROM extracto_movimiento_detalle d , extracto_movimiento m , extractos_movimiento_tipo t, extracto_financiero_int e , cuentas_financiero c, rendimiento_financiero_int i "
