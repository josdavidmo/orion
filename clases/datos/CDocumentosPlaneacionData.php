 ...
 */
class CDocumentosPlaneacionData {

    var $db = null;

    function CDocumentosPlaneacionData($db) {
        $this->db = $db;
    }

    function getManuales($criterio, $orden, $dirOperador) {
        $manuales = null;
        $sql = "select * from documentosPlaneacion "
    ...
    function getManualById($id) {
        $manual = null;
        $sql = "select * from documentosPlaneacion where man_id = " . $id;
