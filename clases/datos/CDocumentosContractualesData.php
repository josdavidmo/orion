 ...
 */
class CDocumentosContractualesData {

    var $db = null;

    function CDocumentosContractualesData($db) {
        $this->db = $db;
    }

    function getManuales($criterio, $orden, $dirOperador) {
        $manuales = null;
        $sql = "select * from documentosContractuales "
    ...
    function getManualById($id) {
        $manual = null;
        $sql = "select * from documentosContractuales where man_id = " . $id;
