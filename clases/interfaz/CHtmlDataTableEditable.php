...
class CHtmlDataTableEditable {
    ...
    function setTablasAsociadas($tablasAsociadas) {
    ...
    function writeDataTable($nivel) {
        ...
        $daoBasicas = new CBasicaData($this->db);
        ?>
                        ...
                        <table id="myTable<?= $this->id ?>" class="table table-bordered table-hover table-condensed">
                            ...
                            <div id="pager<?= $this->id ?>">
                                <form>
                                    ...
                                    <input type="text" id="pagedisplay<?= $this->id ?>" class="pagedisplay" style="background-color: #54acd2; text-align: center">
                                        ...
                                        <tr>
                                            ...
                                            <?php foreach ($row as $cell) { ?>
                                                ...
                                                if ($j != 0) {
                                                    ...
                                                    <?php if(isset($this->tablasAsociadas[$j - 1])) { ?>
                                                    <td>
                                                        <select id="cell<?=$i.$j?>">
                                                            <option value="">Seleccione</option>
                                                    <?php
                                                    $opciones = $daoBasicas->getBasicas($this->tablasAsociadas[$j - 1]);
                                                    if (isset($opciones)) {
                                                        foreach ($opciones as $opcion) { 
                                                            if($opcion->getDescripcion() == $cell){?>
                                                            <option value="<?= $opcion->getId()?>" selected><?= $opcion->getDescripcion()?></option>
                                                            <?php } else { ?>
                                                            <option value="<?= $opcion->getId()?>"><?= $opcion->getDescripcion()?></option>    
                                                            <?php }  }
                                                    }
                                                    ?>        
                                                        </select>
                                                    ...
                                                    <?php } else {?>
                                                        <td><input type="text" id="cell<?=$i.$j?>" value="<?= $html->traducirTildes($cell) ?>"></td>
                                                    <?php } ?>
                                                <?php } else { ?>
                                                    <?php $id = $cell; ?>
                                                <?php } ?>
                                            ...
                                            <?php if (isset($this->addLink) || isset($this->seeLink) || isset($this->editLink) || isset($this->deleteLink) || isset($this->otrosLink)) { ?>
                                                <td nowrap>
                                                    <input type="hidden" value="<?= $id ?>" id="cell<?= $i.$j ?>">
