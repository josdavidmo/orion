...
Class CCompromiso {
    ...
    function saveNewCompromiso() {
        ...
        if ($i == "true") {
            ...
            $compromiso=$this->cc->db->getMaxValue('compromiso','com_id');
            $resData = new CCompromisoResponsableData($this->cc->db);
        
            $responsablenuevo = new CCompromisoResponsable('', $compromiso, $this->responsable, $resData);
