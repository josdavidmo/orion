 ...
 * @author REDCOM
 */
class CExtractoFinancieroInterventoria {
    ...
    function saveExtracto(){
        ...
        if ($i == "true") {
            ...
            $mes = $this->mes;
            $anio = $this->anio;
            $dataRendimiento = new CRendimientoFinancieroInterventoriaData($this->data->db);
            
            $rendimiento = new CRendimientoFinancieroInterventoria('',$dataRendimiento);
