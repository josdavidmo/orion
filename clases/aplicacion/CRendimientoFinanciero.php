...
/**
 * Usada para todas las funciones de negocio referente a rendimientos para el modulo financiero
 *
 * @package  clases
 * @subpackage datos
 */
class CRendimientoFinanciero {
    ...
    function updateRendimiento(){
        ...
        $nombre_compuesto_consignacion = "UT".RENDIMIENTOS_DOCUMENTO_CONSIGNACION."-".$this->cuenta.$this->anio.$this->mes.".".$extension_consignacion[$pos_consignacion];
        if(!move_uploaded_file($this->comprobante_consignacion['tmp_name'], utf8_decode($ruta . $nombre_compuesto_consignacion))){
            return ERROR_COPIAR_ARCHIVO_RENDIMIENTOS_CONSIGNACION;
        }
        ...
        $nombre_compuesto_emision = "UT".RENDIMIENTOS_DOCUMENTO_EMISION."-".$this->cuenta.$this->anio.$this->mes.".".$extension_emision[$pos_emision];
        if(!move_uploaded_file($this->comprobante_emision['tmp_name'], utf8_decode($ruta . $nombre_compuesto_emision))){
            return ERROR_COPIAR_ARCHIVO_RENDIMIENTOS_EMISION;
