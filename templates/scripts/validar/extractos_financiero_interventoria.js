...
function exportar_archivo_excel_extracto_int(){
    document.getElementById('frm_listar_extracto').action = 'modulos/interventoria/extractos_excel.php';
    document.getElementById('frm_listar_extracto').submit();
}

function exportar_archivo_excel_movimiento_int(){
    document.getElementById('frm_listar_movs').action = 'modulos/interventoria/movimientos_excel.php';
    document.getElementById('frm_listar_movs').submit();
}

function exportar_archivo_excel_rendimiento_int(){
    document.getElementById('frm_listar_rendimientos').action = 'modulos/interventoria/rendimientos_excel.php';
