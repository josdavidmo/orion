...
/*
 * Exporta las respuestas de las encuestas mostradas en la tabla del modulo a un documento de excel
 */
function exportar_encuestas_excel() {
    document.getElementById('frm_list_ejecucion').action = 'modulos/ejecucion/exportar_encuestas_excel.php';
    document.getElementById('frm_list_ejecucion').submit();
}
/*
 * Exporta las respuestas de las encuestas mostradas en la tabla del modulo a un documento de excel
 */
function exportar_encuestas_individuos() {
    document.getElementById('frm_list_ejecucion').action = 'modulos/ejecucion/exportar_encuestas_individuos.php';
    document.getElementById('frm_list_ejecucion').submit();
}
/*
 * Exporta las respuestas de las encuestas mostradas en la tabla del modulo a un documento de excel
 */
function exportar_encuestas_organizaciones() {
    document.getElementById('frm_list_ejecucion').action = 'modulos/ejecucion/exportar_encuestas_organizaciones.php';
    document.getElementById('frm_list_ejecucion').submit();
}
